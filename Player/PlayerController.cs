...
public class PlayerController : EntityBehaviour<IPhysicState>
{
    ...
    private void PollKeys()
    {
        ...
        _difuse = Input.GetKey(KeyCode.F);
    ...
    public override void SimulateController()
    {
        ...
        input.Difuse = _difuse;

        entity.QueueInput(input);

        _playerMotor.ExecuteCommand(_forward, _backward, _left, _right, _jump, _yaw, _pitch, _ability1, _ability2, _difuse);
